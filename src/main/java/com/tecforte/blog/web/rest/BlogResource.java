...
public class BlogResource {
    ...
    public ResponseEntity<Void> cleanBlog(@PathVariable String keyword) {
    ...
    public ResponseEntity<Void> cleanBlogEntries(@PathVariable Long id, String keyword) {
        blogService.cleanEntries(id,keyword);
        return ResponseEntity.noContent().headers(HeaderUtil.createEntityDeletionAlert(applicationName, false, ENTITY_NAME, id.toString())).build();
    }
}
